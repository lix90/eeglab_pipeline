...
output_fn = fullfile(output_dir, strcat(id, '_control_postica.set'));
...
for i = 1:numel(id)
    ...
    try
    mat = parload(fullfile(g.base_dir, g.ica_output_folder, strcat(id{i}, '_control_ica.mat')));
