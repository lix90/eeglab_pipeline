...
g.base_dir = '~/data_processing/huyajuan_coma_oddball';
g.raw_folder = 'CON_oddball'; 
g.ica_output_folder = 'ica_CON_oddball'; 
g.postica_output_folder = 'postica_oddball'; 
g.split_output_folder = 'postica_oddball';
g.file_ext = {'dap'};
...
g.epoch_eventnames = {'standard', 'oddball'};
...
%% create study
g.study_name = 'huyajuan_coma_oddball';
